...
<html>
	...
	<body>
		...
		<h2>Hockey Current Elo Ratings
					<!--facebook-->
					<div class="fb-share-button" data-href="http://www.crowdscoutsports.com/hockey_rankings.php" data-layout="button_count"></div>

					<!--twitter  			 data-size="large"-->
					<a href="https://twitter.com/share" class="twitter-share-button" data-url="crowdscoutsports.com/hockey_rankings.php" 
					data-text="CrowdScout Sports - if you really like sports: crowdscoutsports.com/hockey_rankings.php"  
